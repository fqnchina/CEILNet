...
--GPU 7
model1 = torch.load('/mnt/codes/reflection/models/model_inpaint_ecnn_25.net')
model2 = torch.load('/mnt/codes/reflection/models/model_inpaint_icnn_25.net')
...
local file = '/mnt/codes/reflection/models/train_inpaint_combine.lua'
